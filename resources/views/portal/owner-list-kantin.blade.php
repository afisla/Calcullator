...
<head>
    ...
    <title>K2Hub — Kantin Merchant Portal</title>
    <meta name="description" content="Pilih warung kantin Anda untuk login ke dashboard pemilik.">
...
<div class="container">
    ...
    <header class="nav-header">
        <a href="{{ route('portal.owner') }}" class="btn-back">
    ...
    <!-- Intro -->
    <section class="intro">
        <span class="intro-badge">Kantin Merchant</span>
        <h1>Pilih Warung Kantin Anda</h1>
        <p>Silakan pilih stand kantin Anda untuk melanjutkan ke login PIN</p>
    </section>

    <!-- Stores Grid -->
    <main class="grid-stores">
        @foreach($stores as $store)
        <a href="{{ route('store.login', $store) }}" class="store-card {{ $store->is_open ? 'status-open' : 'status-closed' }}">
            <div>
